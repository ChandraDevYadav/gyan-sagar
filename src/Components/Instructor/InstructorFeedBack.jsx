    ...
    <div className='bg-white'>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="relative w-full h-full ">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="relative flex items-center justify-center">
                                    ...
                                    {/* Play Button Icon */}
                                    <button className="relative z-10 flex items-center justify-center w-16 h-16 bg-white text-orange-600 rounded-full shadow-lg">
            ...
            <div className='flex flex-col justify-center items-center'>
                ...
                <p className='mx-10 mt-4 text-lg'>Rapidiously build collaboration anden deas sharing viaing and bleedng edgeing nterfaces fnergstcally plagiarize teams anbuilding paradgms whereas goingi forward process and monetze</p>
                </div>
